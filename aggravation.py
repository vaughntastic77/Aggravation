...
# Load board image
board = pg.transform.scale(pg.image.load("images/board.png"),(800,800))

# Load marble images
marbSize = 29
red = pg.transform.scale(pg.image.load("images/red.png"),(marbSize,marbSize))
blu = pg.transform.scale(pg.image.load("images/blue.png"),(marbSize,marbSize))
gre = pg.transform.scale(pg.image.load("images/green.png"),(marbSize,marbSize))
yel = pg.transform.scale(pg.image.load("images/yellow.png"),(marbSize,marbSize))
marbs = [red,blu,gre,yel]

# Load the dice face images
diceFaces = [pg.transform.scale(pg.image.load(f"images/die{i}.png"),(50,50)) for i in range(1, 7)]
...
#----------------------------------------------------------------------------------------------------------------------
def saveGame():
    np.savez("savedGame.npz",pos=pos,atStart=atStart,atStartout=atStartout,atHome=atHome,atCenter=atCenter,turn=turn,nPlayers=nPlayers,computers=computers)
